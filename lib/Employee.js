    ...
    askQuestions() {
            inquirer.prompt(this.questions)
                .then(function(answers) {
                    if (typeof answers.personName !== "undefined") setPersonName(answers.personName)
                    if (typeof answers.employeeId !== "undefined") setEmployeeId(answers.employeeId)
                    if (typeof answers.email !== "undefined") setEmail(answers.email)
                    if (typeof answers.info !== "undefined") setInfo(answers.info)
                })
