    ...
    askQuestions() {
            inquirer.prompt(this.questions)
                .then(function(answers) {
                    if (typeof answers.personName !== "undefined") this.setPersonName(answers.personName)
                    if (typeof answers.employeeId !== "undefined") this.setEmployeeId(answers.employeeId)
                    if (typeof answers.email !== "undefined") this.setEmail(answers.email)
                    if (typeof answers.info !== "undefined") this.setInfo(answers.info)
                })
